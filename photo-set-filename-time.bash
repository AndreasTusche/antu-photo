...
#
# NAME
#   photo-set-filename-time.bash - set filename to time found in filename
#
# USAGE
#   photo-set-filename-time.bash [FILENAME|DIRNAME]
#
# DESCRIPTION
#   Digits found in the filename are interpreted as date and time and the file
#	is then renamed. The exif header of the files are not modified.
#
# AUTHOR
